...
NGraphics = {
	...
	BORDER_COLOR_DEMILITARIZED_R = 0.0, --1.0
	BORDER_COLOR_DEMILITARIZED_G = 0.0, -- 0.06
	BORDER_COLOR_DEMILITARIZED_B = 0.0, -- 0.0
	BORDER_COLOR_DEMILITARIZED_A = 0.0, -- 0.9
	...
	VICTORY_POINTS_DISTANCE_CUTOFF = {180, 550, 1100}, -- At what distance VPs are hidden
